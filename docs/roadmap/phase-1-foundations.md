...
- [ ] Verify real kubelet reconnection and replacement-machine bootstrap, including runtime/CNI and workload execution, after the verified [offsite etcd/API, controller and node-certificate checks](../runbooks/disaster-recovery.md#isolated-etcd-and-api-verification)
