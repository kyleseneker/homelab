...
- [ ] Complete restored controller-manager/scheduler convergence, kubelet reconnection and replacement-node bootstrapping after the verified [offsite etcd/PKI and API restore](../runbooks/disaster-recovery.md#isolated-etcd-and-api-verification)
