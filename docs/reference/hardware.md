...
All equipment except the router lives in a network closet. The Dream Router 7 sits on the main floor and connects to the closet via a single Gigabit Ethernet uplink.
...
16-port Gigabit PoE managed switch with 2x 1G SFP uplink ports.

### U6 Extenders

Wi-Fi 6 access points deployed in multiple locations throughout the house.
...
Per-outlet power monitoring and switching for all rack equipment. No UPS.
